...
the readers attention specifically to the Connect 4 individual
...
and editing the project plan based on the advisors formative feedback.
...
to the individuals needs. The goal is not simply to teach programming
...
repeatedly by automatically playing the students strategy against this
...
what is needed to successfully complete the module: be proactive, dont
...
Both worked on their teams poster and displayed the most
